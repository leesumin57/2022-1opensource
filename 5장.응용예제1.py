...
throwcount, concount =0, 0 # 던진 횟수, 연속된 숫자 횟수
...
if __name__ == "__main__" :
    ...
    print('6개가 동일한 숫자가 나올 때까지, 1~6의 연속번호 나온 횟수 -->', concount)

# unindent does not match any outer indentation level : 들여쓰기 칸 수 맞추기
# break outside loop
